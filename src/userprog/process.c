...
process_wait (tid_t child_tid UNUSED) 
{
  ...
  for(;;) ;
 // while(1){} 
/* to allow more time for the process to get excute if you are not implementing it*/ 
  return -1;
}
...
setup_stack (void **esp, char * file_name) 
{
  ...
  char ** argv = malloc (size * sizeof(char *)); //using malloc for dynamic allocation of the array
